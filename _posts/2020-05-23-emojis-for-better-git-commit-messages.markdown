...
| 🎒`:school_satchel:` 🚀`:rocket:` ✈️`:airplane:` ⬆️`:arrow_up:` ⏫`:arrow_double_up:` 🔼`:arrow_up_small:` 🆙`:up:` 📢`:loudspeaker:` 🔈`:speaker:` 📯`:postal_horn:` 🎈`:balloon:` 🎊`:confetti_ball:` 🎉`:tada:` 📰`:newspaper:` 🗞`:newspaper_roll:` 📡`:satellite:` 🛰`:artificial_satellite:` | deploy, install, setup, launch |
